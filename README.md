...
Add this module directly to your project using Git submodules for easy updates:
...
Then in Projucer:
- The module should be automatically detected in your `Modules` folder
- Or manually add it via **Modules** tab → **+** → "Add a module from a specified folder"
...
Download and copy the entire `juce_native_macos_dialogs` folder to your project's `Modules` directory, then in Projucer:
- Go to **Modules** tab
- Click **+** button
...
https://github.com/reales/juce_native_macos_dialogs
